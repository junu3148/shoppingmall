...
<body>
	...
	<div class="container" id="container">
		...
		<div class="form-container sign-in-container">
			<form action="${pageContext.request.contextPath}/customer/join" method="get" id="joinForm">
				<h1>회원가입</h1>
				<div class="social-container">
					<a href="#" class="social"><i class="fab fa-facebook-f"></i></a> <a href="#" class="social"><i
							class="fab fa-google-plus-g"></i></a> <a href="#" class="social"><i class="fab fa-linkedin-in"></i></a>
				</div>
		...
		<div class="overlay-container">
			<div class="overlay">
				...
				<div class="overlay-panel overlay-right">
					<h1>회원이신가요?</h1>
					<p>지금 바로 로그인하세요!</p>
					<a class="btn btn-outline-light btn-lg " href="${pageContext.request.contextPath}/customer/loginPage"> 로그인
						페이지로 이동하기 </a>
				</div>
			</div>
		</div>

...
<div id="wrap">
		...
		<br>
			...
			<table id="payment-form">
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;<img src= "${pageContext.request.contextPath}/upload/${product.saveName}" class = "product-img">${product.productName} ${product.productEa} ${product.price}원 </td>
				</tr>
				</c:forEach>
				<tr>
					<td>
						<hr>
							총 ${orderInfo.totalPrice} 원
						<hr>
					</td>
				</tr>
				<tr>
